...
var addEvents = (events) =>{
    ...
    if( events >3 || events<1 ){
        ...
        for(i=0; i<events; i++){
            ...
            `     <div class="form-group mb-4" > <select id="event${i + 1}" name=\"account\" class=\"form-control border-0 shadow form-control-lg\" onChange="validate(event.srcElement.id,value)">` +
...
var validate=(id, value) =>{
    ...
    if( value == specialEventValue){
        ...
        kitbox.innerHTML =`Need kit for ${value}` ;
